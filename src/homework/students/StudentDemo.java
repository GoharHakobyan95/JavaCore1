...
public class StudentDemo implements Commands {
    ...
    public static void main(String[] args) {
        ...
        studentStorage.add(new Student("Poghos", "Pogosyan", 25, "077077077", "Gyumri", java, admin));
        studentStorage.add(new Student("Petros", "Petrosyan", 35, "094094094", "Gyumri", javaScript, admin));
        studentStorage.add(new Student("Martiros", "Martirosyan", 18, "098098098", "Gyumri", english, admin));
